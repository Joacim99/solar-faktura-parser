...
if uploaded_file is not None:
    with st.spinner("Leser PDF og parser tekst..."):
        try:
            ...
            skip_patterns = ["Total", "Totalt", "Å betale", "Momspliktig", "MVA-beløp", "MVA-kode", "VAT", "Solar Norge AS", "Faktura", "Leveringsadresse", "Kjøperens adresse", "Din referanse", "Ditt MVA-nr.", "Ditt org. nr.", "Leveringsdato", "Angis ved betaling", "Forfallsdato", "Vår referanse", "E-post", "Vårt ordrenummer", "Generated by", "Kontonummer", "Organisasjonsnummer", "Foretaksregisteret"]
