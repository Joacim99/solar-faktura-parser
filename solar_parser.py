...
if uploaded_file is not None:
    with st.spinner("Leser PDF og parser tekst..."):
        try:
            ...
            # Hopp over header og footer-linjer
            skip_patterns = ["Solar Norge AS", "Faktura", "Leveringsadresse", "Kjøperens adresse", "Din referanse", "Ditt MVA-nr.", "Ditt org. nr.", "Leveringsdato", "Angis ved betaling", "Forfallsdato", "Vår referanse", "E-post", "Vårt ordrenummer", "Totalt", "Total", "Å betale", "Momspliktig", "MVA-beløp", "MVA-kode", "VAT", "Generated by", "Kontonummer", "Organisasjonsnummer", "Foretaksregisteret"]
